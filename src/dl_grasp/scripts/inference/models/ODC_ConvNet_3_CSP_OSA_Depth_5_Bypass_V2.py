...
class Generative_ODC_3_CSP_OSA_Depth_5_Bypass_V2(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODC_3_CSP_OSA_Depth_5_Bypass_V2, self).__init__()

        print("Generative_ODC_3_CSP_OSA_Depth_5_Bypass_V2")
