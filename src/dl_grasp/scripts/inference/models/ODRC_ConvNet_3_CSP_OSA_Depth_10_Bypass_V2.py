...
from inference.models.rfb_v2 import BasicRFB_a

class Generative_ODRC_3_CSP_OSA_Depth_10_Bypass_V2(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODRC_3_CSP_OSA_Depth_10_Bypass_V2, self).__init__()

        print("Generative_ODRC_3_CSP_OSA_Depth_10_Bypass_V2")
        ...
        self.rfb1 = BasicRFB_a(self.csp_trans2_out_kernal, self.csp_trans2_out_kernal, stride = 1, scale=1.0)

        self.cbam3 = CBAM(self.concat_1_size)
        ...
        self.cbam4 = CBAM(self.concat_2_size)
