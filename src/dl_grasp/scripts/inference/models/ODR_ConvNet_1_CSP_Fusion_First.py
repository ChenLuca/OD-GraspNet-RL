...
class Generative_ODR_1_CSP_Fusion_First(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODR_1_CSP_Fusion_First, self).__init__()

        print("Generative_ODR_1_CSP_Fusion_First")
        ...
        self.rfb = BasicRFB_a(self.trans4_out_kernal, self.trans4_out_kernal)
