...
class Generative_ODR_3_CSP_OSA_Depth_10(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODR_3_CSP_OSA_Depth_10, self).__init__()

        print("Generative_ODR_3_CSP_OSA_Depth_10")
        ...
        self.rfb = BasicRFB_a(self.csp_trans2_out_kernal, self.csp_trans2_out_kernal)

        self.conv4 = nn.ConvTranspose2d(self.csp_trans2_out_kernal, channel_size * 2, kernel_size=4, stride=2, padding=1,
                                        output_padding=1)
