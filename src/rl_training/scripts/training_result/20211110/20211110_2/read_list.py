...
train_loss_file = "TRAIN_LOSS.pkl"
avf_return_file = "AVG_RETURN.pkl"
step_file = "STEP.pkl"
...
if (sys.argv[1]=="l"):
    ...
    ax.set(xlim=(0, 80000), xlabel='step', ylabel='loss', title='TRAIN_LOSS')
    ...
    bx.set(xlim=(0, 80000), xlabel='step', ylabel='average return', title='AVG_RETURN')
